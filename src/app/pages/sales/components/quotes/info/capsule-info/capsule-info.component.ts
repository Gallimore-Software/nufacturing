...
export class CapsuleInfoComponent implements OnInit {
  ...
  capsuleParts = [
    'ECHPMC00C', 'ECTR00C', 'LZETC00C', 'ECGELATIN00C', 'ECHPMC0CDR', 'ECHPMC0C'
  ];

  productColors = [
    'Tan', 'White', 'Green', 'Red', 'Green/Tan', 'TBD'
  ];

  capsuleDetails: { [key: string]: CapsuleDetail } = {
    'ECHPMC00C': { material: '(HPMC)', length: '0.917"', diameter: '0.336"', size: '00', weight: 124, colorShell: 'Clear', price: '$0.00710' },
    'ECTR00C': { material: 'Delayed Release', length: '0.917"', diameter: '0.336"', size: '00', weight: 124, colorShell: 'Clear', price: '0.0' },
    'LZETC00C': { material: 'Enteric Coated', length: '0.917"', diameter: '0.336"', size: '00', weight: 124, colorShell: 'Clear', price: '0.0' },
    'ECGELATIN00C': { material: 'Gelatin', length: '0.917"', diameter: '0.336"', size: '00', weight: 124, colorShell: 'Clear', price: '$0.00365' },
    'ECHPMC0CDR': { material: 'Delayed Release', length: '0.8429"', diameter: '0.2886"', size: '0', weight: 95, colorShell: 'Clear', price: '$0.009950' },
    'ECHPMC0C': { material: 'HMPC', length: '0.8429"', diameter: '0.2886"', size: '0', weight: 95, colorShell: 'Clear', price: '$0.004000' }
  };
  ...
  private createDataSource(formValues: any): any[] {
    const details: CapsuleDetail = this.capsuleDetails[formValues.nfgCapsulePart];
    return [
